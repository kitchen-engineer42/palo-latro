...
M.lessons = {
  ...
  },
  {
    ...
    title = "Pick a market",
    body = "Start with Indie SaaS. Its Extra Sprint perk gives you five Ships—not four—to reach each blind target.",
    prompt = "Choose Indie SaaS.",
  },
  {
    id = "selection", after = "market", trigger = "blind_started", complete = "cards_selected",
    title = "Choose the stack",
    body = "Different Layer colors build different products. Pick three or four cards; the preview above Ship shows what the stack will score.",
    prompt = "Click Tech cards to select them.",
  },
  {
    id = "ship", after = "selection", trigger = "cards_selected", complete = "ship_committed",
    title = "Ship it",
    body = "Users × Revenue per user becomes ARR. Every Ship adds that ARR to the yellow blind target on the left.",
    prompt = "Press Ship to score this stack.",
  },
  {
    id = "pivot", after = "ship", trigger = "ship_scored", complete = "pivot_committed",
    title = "Pivot with intent",
    body = "The bottom Pivot button discards selected Tech cards and draws replacements. It does not change your Market.",
    prompt = "Select an awkward Tech card, then press Pivot.",
  },
  {
