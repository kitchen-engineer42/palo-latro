...
local FIXTURES = {
  ...
  overlap = {
    hand = {
      ...
      cards = {
        { id = "hand-01", index = 1, x = 160, y = 520, w = 90, h = 120 },
        { id = "hand-02", index = 2, x = 220, y = 520, w = 90, h = 120, hovered = true },
        { id = "hand-03", index = 3, x = 280, y = 494, w = 90, h = 120, selected = true },
        { id = "hand-04", index = 4, x = 340, y = 520, w = 90, h = 120 },
        { id = "hand-05", index = 5, x = 400, y = 520, w = 90, h = 120 },
      },
    },
    founders = {
